...
class JobVacancyUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'sometimes|required|in:Full-Time,Contract,Remote,Hybrid',
            'description' => 'sometimes|required|string',
            'companyId' => 'sometimes|required|exists:companies,id',
            'categoryId' => 'sometimes|required|exists:job_categories,id',
        ];
    }
