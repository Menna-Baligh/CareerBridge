        ...
        <div class="flex items-center justify-between mb-4">
            ...
            @if (!request('archived'))
                <a href="{{ route('job-vacancy.create') }}"
                    class="flex items-center text-purple-600 hover:text-purple-800 font-semibold transition">
                        ...
                        <tr class="hover:bg-purple-50 transition">
                            <td class="px-6 py-4 text-gray-800 font-medium">
                                ...
                                <td class="px-6 py-4 text-gray-600">
                                    USD {{ Number::abbreviate($job->salary) }}
                                </td>
                            <td class="px-6 py-4 flex items-center space-x-3">
                                ...
                                @else
                                    <a href="{{ route('job-vacancy.edit', $job) }}"
                                    ...
                                    <form action="{{ route('job-vacancy.destroy', $job) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
